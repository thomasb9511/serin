...
int main()
{
    ...
    {
        a<CryptoPP::HIGHT>(key_vec[i]);
        b<CryptoPP::HIGHT>(key_vec[i]);
        c<CryptoPP::HIGHT>(key_vec[i]);
        d<CryptoPP::HIGHT>(key_vec[i]);
        e<CryptoPP::HIGHT>(key_vec[i]);
        f<CryptoPP::HIGHT>(key_vec[i]);
        g<CryptoPP::HIGHT>(key_vec[i]);
        h<CryptoPP::HIGHT>(key_vec[i]);

        a<CryptoPP::LEA>(key_vec[i]);
        b<CryptoPP::LEA>(key_vec[i]);
        c<CryptoPP::LEA>(key_vec[i]);
        d<CryptoPP::LEA>(key_vec[i]);
        e<CryptoPP::LEA>(key_vec[i]);
        f<CryptoPP::LEA>(key_vec[i]);
        g<CryptoPP::LEA>(key_vec[i]);
        h<CryptoPP::LEA>(key_vec[i]);

        a<CryptoPP::DES_EDE3>(key_vec[i]);
        b<CryptoPP::DES_EDE3>(key_vec[i]);
        c<CryptoPP::DES_EDE3>(key_vec[i]);
        d<CryptoPP::DES_EDE3>(key_vec[i]);
        e<CryptoPP::DES_EDE3>(key_vec[i]);
        f<CryptoPP::DES_EDE3>(key_vec[i]);
        g<CryptoPP::DES_EDE3>(key_vec[i]);
        h<CryptoPP::DES_EDE3>(key_vec[i]);

        a<CryptoPP::DES_EDE2>(key_vec[i]);
        b<CryptoPP::DES_EDE2>(key_vec[i]);
        c<CryptoPP::DES_EDE2>(key_vec[i]);
        d<CryptoPP::DES_EDE2>(key_vec[i]);
        e<CryptoPP::DES_EDE2>(key_vec[i]);
        f<CryptoPP::DES_EDE2>(key_vec[i]);
        g<CryptoPP::DES_EDE2>(key_vec[i]);
        h<CryptoPP::DES_EDE2>(key_vec[i]);

        a<CryptoPP::IDEA>(key_vec[i]);
        b<CryptoPP::IDEA>(key_vec[i]);
        c<CryptoPP::IDEA>(key_vec[i]);
        d<CryptoPP::IDEA>(key_vec[i]);
        e<CryptoPP::IDEA>(key_vec[i]);
        f<CryptoPP::IDEA>(key_vec[i]);
        g<CryptoPP::IDEA>(key_vec[i]);
        h<CryptoPP::IDEA>(key_vec[i]);

        a<CryptoPP::SPECK128>(key_vec[i]);
        b<CryptoPP::SPECK128>(key_vec[i]);
        c<CryptoPP::SPECK128>(key_vec[i]);
        d<CryptoPP::SPECK128>(key_vec[i]);
        e<CryptoPP::SPECK128>(key_vec[i]);
        f<CryptoPP::SPECK128>(key_vec[i]);
        g<CryptoPP::SPECK128>(key_vec[i]);
        h<CryptoPP::SPECK128>(key_vec[i]);

        a<CryptoPP::SPECK64>(key_vec[i]);
        b<CryptoPP::SPECK64>(key_vec[i]);
        c<CryptoPP::SPECK64>(key_vec[i]);
        d<CryptoPP::SPECK64>(key_vec[i]);
        e<CryptoPP::SPECK64>(key_vec[i]);
        f<CryptoPP::SPECK64>(key_vec[i]);
        g<CryptoPP::SPECK64>(key_vec[i]);
        h<CryptoPP::SPECK64>(key_vec[i]);

        a<CryptoPP::SIMECK32>(key_vec[i]);
        b<CryptoPP::SIMECK32>(key_vec[i]);
        c<CryptoPP::SIMECK32>(key_vec[i]);
        d<CryptoPP::SIMECK32>(key_vec[i]);
        e<CryptoPP::SIMECK32>(key_vec[i]);
        f<CryptoPP::SIMECK32>(key_vec[i]);
        g<CryptoPP::SIMECK32>(key_vec[i]);
        h<CryptoPP::SIMECK32>(key_vec[i]);

        a<CryptoPP::SIMECK64>(key_vec[i]);
        b<CryptoPP::SIMECK64>(key_vec[i]);
        c<CryptoPP::SIMECK64>(key_vec[i]);
        d<CryptoPP::SIMECK64>(key_vec[i]);
        e<CryptoPP::SIMECK64>(key_vec[i]);
        f<CryptoPP::SIMECK64>(key_vec[i]);
        g<CryptoPP::SIMECK64>(key_vec[i]);
        h<CryptoPP::SIMECK64>(key_vec[i]);

        a<CryptoPP::SIMON128>(key_vec[i]);
        b<CryptoPP::SIMON128>(key_vec[i]);
        c<CryptoPP::SIMON128>(key_vec[i]);
        d<CryptoPP::SIMON128>(key_vec[i]);
        e<CryptoPP::SIMON128>(key_vec[i]);
        f<CryptoPP::SIMON128>(key_vec[i]);
        g<CryptoPP::SIMON128>(key_vec[i]);
        h<CryptoPP::SIMON128>(key_vec[i]);

        a<CryptoPP::SIMON64>(key_vec[i]);
        b<CryptoPP::SIMON64>(key_vec[i]);
        c<CryptoPP::SIMON64>(key_vec[i]);
        d<CryptoPP::SIMON64>(key_vec[i]);
        e<CryptoPP::SIMON64>(key_vec[i]);
        f<CryptoPP::SIMON64>(key_vec[i]);
        g<CryptoPP::SIMON64>(key_vec[i]);
        h<CryptoPP::SIMON64>(key_vec[i]);

        a<CryptoPP::SEED>(key_vec[i]);
        b<CryptoPP::SEED>(key_vec[i]);
        c<CryptoPP::SEED>(key_vec[i]);
        d<CryptoPP::SEED>(key_vec[i]);
        e<CryptoPP::SEED>(key_vec[i]);
        f<CryptoPP::SEED>(key_vec[i]);
        g<CryptoPP::SEED>(key_vec[i]);
        h<CryptoPP::SEED>(key_vec[i]);

        a<CryptoPP::SKIPJACK>(key_vec[i]);
        b<CryptoPP::SKIPJACK>(key_vec[i]);
        c<CryptoPP::SKIPJACK>(key_vec[i]);
        d<CryptoPP::SKIPJACK>(key_vec[i]);
        e<CryptoPP::SKIPJACK>(key_vec[i]);
        f<CryptoPP::SKIPJACK>(key_vec[i]);
        g<CryptoPP::SKIPJACK>(key_vec[i]);
        h<CryptoPP::SKIPJACK>(key_vec[i]);

        a<CryptoPP::RC6>(key_vec[i]);
        b<CryptoPP::RC6>(key_vec[i]);
        c<CryptoPP::RC6>(key_vec[i]);
        d<CryptoPP::RC6>(key_vec[i]);
        e<CryptoPP::RC6>(key_vec[i]);
        f<CryptoPP::RC6>(key_vec[i]);
        g<CryptoPP::RC6>(key_vec[i]);
        h<CryptoPP::RC6>(key_vec[i]);

        a<CryptoPP::Camellia>(key_vec[i]);
        b<CryptoPP::Camellia>(key_vec[i]);
        c<CryptoPP::Camellia>(key_vec[i]);
        d<CryptoPP::Camellia>(key_vec[i]);
        e<CryptoPP::Camellia>(key_vec[i]);
        f<CryptoPP::Camellia>(key_vec[i]);
        g<CryptoPP::Camellia>(key_vec[i]);
        h<CryptoPP::Camellia>(key_vec[i]);

        a<CryptoPP::SHACAL2>(key_vec[i]);
        b<CryptoPP::SHACAL2>(key_vec[i]);
        c<CryptoPP::SHACAL2>(key_vec[i]);
        d<CryptoPP::SHACAL2>(key_vec[i]);
        e<CryptoPP::SHACAL2>(key_vec[i]);
        f<CryptoPP::SHACAL2>(key_vec[i]);
        g<CryptoPP::SHACAL2>(key_vec[i]);
        h<CryptoPP::SHACAL2>(key_vec[i]);

        a<CryptoPP::AES>(key_vec[i]);
        b<CryptoPP::AES>(key_vec[i]);
        c<CryptoPP::AES>(key_vec[i]);
        d<CryptoPP::AES>(key_vec[i]);
        e<CryptoPP::AES>(key_vec[i]);
        f<CryptoPP::AES>(key_vec[i]);
        g<CryptoPP::AES>(key_vec[i]);
        h<CryptoPP::AES>(key_vec[i]);

        a<CryptoPP::Twofish>(key_vec[i]);
        b<CryptoPP::Twofish>(key_vec[i]);
        c<CryptoPP::Twofish>(key_vec[i]);
        d<CryptoPP::Twofish>(key_vec[i]);
        e<CryptoPP::Twofish>(key_vec[i]);
        f<CryptoPP::Twofish>(key_vec[i]);
        g<CryptoPP::Twofish>(key_vec[i]);
        h<CryptoPP::Twofish>(key_vec[i]);

        a<CryptoPP::Blowfish>(key_vec[i]);
        b<CryptoPP::Blowfish>(key_vec[i]);
        c<CryptoPP::Blowfish>(key_vec[i]);
        d<CryptoPP::Blowfish>(key_vec[i]);
        e<CryptoPP::Blowfish>(key_vec[i]);
        f<CryptoPP::Blowfish>(key_vec[i]);
        g<CryptoPP::Blowfish>(key_vec[i]);
        h<CryptoPP::Blowfish>(key_vec[i]);

        a<CryptoPP::Serpent>(key_vec[i]);
        b<CryptoPP::Serpent>(key_vec[i]);
        c<CryptoPP::Serpent>(key_vec[i]);
        d<CryptoPP::Serpent>(key_vec[i]);
        e<CryptoPP::Serpent>(key_vec[i]);
        f<CryptoPP::Serpent>(key_vec[i]);
        g<CryptoPP::Serpent>(key_vec[i]);
        h<CryptoPP::Serpent>(key_vec[i]);

        a<CryptoPP::CHAM128>(key_vec[i]);
        b<CryptoPP::CHAM128>(key_vec[i]);
        c<CryptoPP::CHAM128>(key_vec[i]);
        d<CryptoPP::CHAM128>(key_vec[i]);
        e<CryptoPP::CHAM128>(key_vec[i]);
        f<CryptoPP::CHAM128>(key_vec[i]);
        g<CryptoPP::CHAM128>(key_vec[i]);
        h<CryptoPP::CHAM128>(key_vec[i]);

        a<CryptoPP::CHAM64>(key_vec[i]);
        b<CryptoPP::CHAM64>(key_vec[i]);
        c<CryptoPP::CHAM64>(key_vec[i]);
        d<CryptoPP::CHAM64>(key_vec[i]);
        e<CryptoPP::CHAM64>(key_vec[i]);
        f<CryptoPP::CHAM64>(key_vec[i]);
        g<CryptoPP::CHAM64>(key_vec[i]);
        h<CryptoPP::CHAM64>(key_vec[i]);

        a<CryptoPP::ARIA>(key_vec[i]);
        b<CryptoPP::ARIA>(key_vec[i]);
        c<CryptoPP::ARIA>(key_vec[i]);
        d<CryptoPP::ARIA>(key_vec[i]);
        e<CryptoPP::ARIA>(key_vec[i]);
        f<CryptoPP::ARIA>(key_vec[i]);
        g<CryptoPP::ARIA>(key_vec[i]);
        h<CryptoPP::ARIA>(key_vec[i]);

        a<CryptoPP::MARS>(key_vec[i]);
        b<CryptoPP::MARS>(key_vec[i]);
        c<CryptoPP::MARS>(key_vec[i]);
        d<CryptoPP::MARS>(key_vec[i]);
        e<CryptoPP::MARS>(key_vec[i]);
        f<CryptoPP::MARS>(key_vec[i]);
        g<CryptoPP::MARS>(key_vec[i]);
        h<CryptoPP::MARS>(key_vec[i]);

        a<CryptoPP::SHARK>(key_vec[i]);
        b<CryptoPP::SHARK>(key_vec[i]);
        c<CryptoPP::SHARK>(key_vec[i]);
        d<CryptoPP::SHARK>(key_vec[i]);
        e<CryptoPP::SHARK>(key_vec[i]);
        f<CryptoPP::SHARK>(key_vec[i]);
        g<CryptoPP::SHARK>(key_vec[i]);
        h<CryptoPP::SHARK>(key_vec[i]);

        a<CryptoPP::Square>(key_vec[i]);
        b<CryptoPP::Square>(key_vec[i]);
        c<CryptoPP::Square>(key_vec[i]);
        d<CryptoPP::Square>(key_vec[i]);
        e<CryptoPP::Square>(key_vec[i]);
        f<CryptoPP::Square>(key_vec[i]);
        g<CryptoPP::Square>(key_vec[i]);
        h<CryptoPP::Square>(key_vec[i]);

        a<CryptoPP::GOST>(key_vec[i]);
        b<CryptoPP::GOST>(key_vec[i]);
        c<CryptoPP::GOST>(key_vec[i]);
        d<CryptoPP::GOST>(key_vec[i]);
        e<CryptoPP::GOST>(key_vec[i]);
        f<CryptoPP::GOST>(key_vec[i]);
        g<CryptoPP::GOST>(key_vec[i]);
        h<CryptoPP::GOST>(key_vec[i]);

        a<CryptoPP::SAFER_K>(key_vec[i]);
        b<CryptoPP::SAFER_K>(key_vec[i]);
        c<CryptoPP::SAFER_K>(key_vec[i]);
        d<CryptoPP::SAFER_K>(key_vec[i]);
        e<CryptoPP::SAFER_K>(key_vec[i]);
        f<CryptoPP::SAFER_K>(key_vec[i]);
        g<CryptoPP::SAFER_K>(key_vec[i]);
        h<CryptoPP::SAFER_K>(key_vec[i]);

        a<CryptoPP::SAFER_SK>(key_vec[i]);
        b<CryptoPP::SAFER_SK>(key_vec[i]);
        c<CryptoPP::SAFER_SK>(key_vec[i]);
        d<CryptoPP::SAFER_SK>(key_vec[i]);
        e<CryptoPP::SAFER_SK>(key_vec[i]);
        f<CryptoPP::SAFER_SK>(key_vec[i]);
        g<CryptoPP::SAFER_SK>(key_vec[i]);
        h<CryptoPP::SAFER_SK>(key_vec[i]);

        a<CryptoPP::CAST128>(key_vec[i]);
        b<CryptoPP::CAST128>(key_vec[i]);
        c<CryptoPP::CAST128>(key_vec[i]);
        d<CryptoPP::CAST128>(key_vec[i]);
        e<CryptoPP::CAST128>(key_vec[i]);
        f<CryptoPP::CAST128>(key_vec[i]);
        g<CryptoPP::CAST128>(key_vec[i]);
        h<CryptoPP::CAST128>(key_vec[i]);

        a<CryptoPP::CAST256>(key_vec[i]);
        b<CryptoPP::CAST256>(key_vec[i]);
        c<CryptoPP::CAST256>(key_vec[i]);
        d<CryptoPP::CAST256>(key_vec[i]);
        e<CryptoPP::CAST256>(key_vec[i]);
        f<CryptoPP::CAST256>(key_vec[i]);
        g<CryptoPP::CAST256>(key_vec[i]);
        h<CryptoPP::CAST256>(key_vec[i]);

        a<CryptoPP::ThreeWay>(key_vec[i]);
        b<CryptoPP::ThreeWay>(key_vec[i]);
        c<CryptoPP::ThreeWay>(key_vec[i]);
        d<CryptoPP::ThreeWay>(key_vec[i]);
        e<CryptoPP::ThreeWay>(key_vec[i]);
        f<CryptoPP::ThreeWay>(key_vec[i]);
        g<CryptoPP::ThreeWay>(key_vec[i]);
        h<CryptoPP::ThreeWay>(key_vec[i]);

        a<CryptoPP::TEA>(key_vec[i]);
        b<CryptoPP::TEA>(key_vec[i]);
        c<CryptoPP::TEA>(key_vec[i]);
        d<CryptoPP::TEA>(key_vec[i]);
        e<CryptoPP::TEA>(key_vec[i]);
        f<CryptoPP::TEA>(key_vec[i]);
        g<CryptoPP::TEA>(key_vec[i]);
        h<CryptoPP::TEA>(key_vec[i]);

        a<CryptoPP::XTEA>(key_vec[i]);
        b<CryptoPP::XTEA>(key_vec[i]);
        c<CryptoPP::XTEA>(key_vec[i]);
        d<CryptoPP::XTEA>(key_vec[i]);
        e<CryptoPP::XTEA>(key_vec[i]);
        f<CryptoPP::XTEA>(key_vec[i]);
        g<CryptoPP::XTEA>(key_vec[i]);
        h<CryptoPP::XTEA>(key_vec[i]);

        a<CryptoPP::RC2>(key_vec[i]);
        b<CryptoPP::RC2>(key_vec[i]);
        c<CryptoPP::RC2>(key_vec[i]);
        d<CryptoPP::RC2>(key_vec[i]);
        e<CryptoPP::RC2>(key_vec[i]);
        f<CryptoPP::RC2>(key_vec[i]);
        g<CryptoPP::RC2>(key_vec[i]);
        h<CryptoPP::RC2>(key_vec[i]);

        a<CryptoPP::RC5>(key_vec[i]);
        b<CryptoPP::RC5>(key_vec[i]);
        c<CryptoPP::RC5>(key_vec[i]);
        d<CryptoPP::RC5>(key_vec[i]);
        e<CryptoPP::RC5>(key_vec[i]);
        f<CryptoPP::RC5>(key_vec[i]);
        g<CryptoPP::RC5>(key_vec[i]);
        h<CryptoPP::RC5>(key_vec[i]);

        a<CryptoPP::DES_XEX3>(key_vec[i]);
        b<CryptoPP::DES_XEX3>(key_vec[i]);
        c<CryptoPP::DES_XEX3>(key_vec[i]);
        d<CryptoPP::DES_XEX3>(key_vec[i]);
        e<CryptoPP::DES_XEX3>(key_vec[i]);
        f<CryptoPP::DES_XEX3>(key_vec[i]);
        g<CryptoPP::DES_XEX3>(key_vec[i]);
        h<CryptoPP::DES_XEX3>(key_vec[i]);
    }
