...
template <typename T>
void output(std::string& filename, std::string mode_name, std::string algo_name) {
    std::string digest = serin::hash::files::hash<T>(filename);
...
int main() {
    int ar[] = {0x00, 0x01, 0x02, 0x04, 0x08, 0x0F, 0x10, 0x11, 0x12, 0x14, 0x18, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24,
                0x28, 0x2F, 0x32, 0x33, 0x35, 0x3C, 0x40, 0x41, 0x42, 0x44, 0x48, 0x4F, 0x53, 0x55, 0x56, 0x59, 0x5A,
                0x5C, 0x65, 0x66, 0x69, 0x77, 0x80, 0x81, 0x82, 0x84, 0x88, 0x8F, 0x95, 0x96, 0x99, 0xA5, 0xAA, 0xBB,
                0xC3, 0xC5, 0xCC, 0xDD, 0xDE, 0xED, 0xEE, 0xF0, 0xF1, 0xF2, 0xF4, 0xF8, 0xFF,};
